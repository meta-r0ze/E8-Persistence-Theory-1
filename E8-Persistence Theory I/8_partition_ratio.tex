...
\begin{equation}
\sin^2 \theta_W = \frac{43}{4(43) + 16 + 5} = \frac{43}{193} \approx = \ExecuteMetaData[src/results.tex]{WeakAngleVal}
\end{equation}
...
\begin{itemize}
    \item \textbf{Geometric Prediction (Integer):} \ExecuteMetaData[src/results.tex]{WeakAngleVal}
