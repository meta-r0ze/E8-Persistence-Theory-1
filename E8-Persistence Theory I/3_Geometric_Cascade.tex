...
\midrule
\multicolumn{5}{c}{\textbf{Active Output Set} $\mathbb{O} = \{ \alpha^{-1} \approx \ExecuteMetaData[src/results.tex]{AlphaInvVal}, \ T, \ PM \}$} \\
...
\midrule
\textbf{Energy Vessel ($\Delta E$)} & Electromagnetism & $\alpha_{geo}^{-1}$ & $\mathbf{\ExecuteMetaData[src/results.tex]{AlphaInvVal}}$ & \textbf{Coupling Baseline:} The reference strength \\
