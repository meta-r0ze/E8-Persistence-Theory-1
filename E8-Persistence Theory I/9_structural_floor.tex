...
\begin{equation}
v = (2 \cdot 43^2 - 188) \cdot \ExecuteMetaData[src/results.tex]{AlphaInvVal} \cdot 0.51099 \text{ MeV}
\end{equation}
\begin{equation}
v = 3510 \cdot \ExecuteMetaData[src/results.tex]{AlphaInvVal} \cdot 0.51099 \text{ MeV} \approx = \ExecuteMetaData[src/results.tex]{HiggsVEVVal} \text{ GeV}
\end{equation}
