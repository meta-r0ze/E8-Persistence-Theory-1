...
\begin{align}
\alpha^{-1} &= 137.035999212 \dots \quad (\text{Fixed}) \\
...
The most immediate test is the convergence of the Fine-Structure Constant. The geometric value ($\alpha^{-1}_{geo} = 137.035999212$) lies between the current electron $g-2$ average and the Cesium recoil measurements.
