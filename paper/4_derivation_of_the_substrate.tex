...
\begin{enumerate}
    ...
    \item To satisfy the \textbf{Chiral Capacity} requirement (Arrow of Time), the symmetry must break to a subgroup supporting complex spinors.
...
\begin{itemize}
    ...
    \item \textbf{The Physical Consequence:} This creates \textbf{Causal Aliasing}. Matter (Left-Chiral) and Mirror (Right-Chiral) signals would collide, destroying the Chiral Capacity and breaking time-ordering.
