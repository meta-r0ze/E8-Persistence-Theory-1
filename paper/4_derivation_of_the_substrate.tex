...
While the Petrie projection of $E_8$ visually exhibits 5-fold symmetry, the physical necessity of $\sigma=5$ arises rigorously from the \textbf{Rank of Unification}. The minimal simple Lie group capable of embedding the Standard Model gauge groups $SU(3)_C \times SU(2)_L \times U(1)_Y$ is $SU(5)$, which has rank 4 and a fundamental representation of dimension 5.
