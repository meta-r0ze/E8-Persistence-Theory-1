...
\CatchFileBetweenTags{\VonKlitzingVal}{calculations/results.tex}{VonKlitzingVal}
\CatchFileBetweenTags{\VonKlitzingExperimentalValue}{calculations/results.tex}{VonKlitzingExperimentalValue}

Von Klitzing Constant (\texorpdfstring{$R_K$}{RK}
...
\subsection{Physical Manifestation: The Von Klitzing Constant ($R_K$)}
