...
\begin{enumerate}
    ...
    \item \textbf{Geometric Impedance ($\alpha^{-1}$):} By applying the Persistence Principle to the substrate, we derive the Fine-Structure Constant not as a tuned parameter, but as the \textbf{Vacuum Impedance}: the aggregate geometric cost required to sustain a coherent signal against the entropic flux of the lattice.
