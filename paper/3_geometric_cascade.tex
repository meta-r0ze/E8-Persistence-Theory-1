...
To anchor the subsequent derivations, we define the System Specification: the immutable geometric eigenvalues of the vacuum topology. These five integers constitute the complete input set from which the physical universe emerges.
...
\begin{itemize}
    ...
    \item \textbf{\hyperref[tab:system_GeometricImpedance]{System II}:} The Geometric Impedance. Defines the metabolic cost of information propagation. ($\alpha^{-1}$).
    \item \textbf{\hyperref[tab:system_EntropicAction]{System III}:} The Entropic Dynamics Derives the Standard Model Lagrangian as the path of least action.
    ...
    \item \textbf{\hyperref[tab:system_BulkRegulator]{System VI}:} Emergent Gravity. Stabilizes the bulk lattice geometry.
    \item \textbf{\hyperref[tab:system_ArchitectureOfMatter]{System VII}:} Architecture of Matter. The resonant particle spectrum.
\end{itemize}
...
\textbf{Protocol ($MI$)} & Channel & $\nu$ & \textbf{16} & Chiral Capacity (Enforcing Arrow of Time) \\
...
\begin{table*}[h]
\centering
\caption{\textbf{System V: The Surface Regulator (Higgs Field).} The nested persistent system that impedance-matches the lattice resonance to the weak force aperture, creating the Mass Scale.}
...
\begin{table*}[h]
\centering
\caption{\textbf{System IV: The Effective Field Limits.} The physical constants of the Standard Model derived as the operational outputs of the Geometric Impedance on the $E_8$ lattice.}
...
\textbf{Temporal Tax ($T$)} & Jarlskog Inv. ($J$) &
    $\JarlskogEq$ & $\mathbf{\JarlskogVal}$ & \textbf{Time Asymmetry:} Cost of the Chiral Capacity. \\
