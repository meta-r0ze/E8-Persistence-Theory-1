...
\textbf{Capacity ($\Delta E$)} & Chiral Bandwidth &
    $v$ & $\mathbf{16}$ & \textbf{foo:} bar \\
\textbf{Info. Model ($\Delta I$)} & Gauge Structure &
    $x$ & $\mathbf{2}$ & \textbf{foo:} bar \\
\addlinespace
