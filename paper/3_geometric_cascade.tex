...
\begin{itemize}
    ...
    \item \textbf{\hyperref[tab:system_GeometricImpedance]{System II}:} The Geometric Impedance ($\alpha^{-1}$).
    \item \textbf{\hyperref[tab:system_EntropicAction]{System III}:} The Entropic Dynamics (Lagrangian).
    \item \textbf{\hyperref[tab:system_EffectiveFieldLimits]{System IV}:} The Effective Field Limits (Standard Model Constants).
    \item \textbf{\hyperref[tab:system_SurfaceRegulator]{System V}:} The Surface Regulator (Higgs Field)
    \item \textbf{\hyperref[tab:system_BulkRegulator]{System VI}:} The Bulk Regulator (Gravity).  
