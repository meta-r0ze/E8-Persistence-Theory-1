...
\end{equation}
The following tables outline the architectural layers of the $E_8$ lattice projection, moving from invariant constraints to observable matter. Importantly only the unique set is used, spanning 47 orders of magnitude from the gravitational coupling ($10^{-45}$) to the Planck mass ($10^{19}$ GeV).

\begin{itemize}
    \item \textbf{\hyperref[tab:system_InvariantSubstrate]{System I}:} The Lattice Substrate (5 invariants).
    \item \textbf{\hyperref[tab:system_EntropicAction]{System II}:} The Entropic Dynamics (Lagrangian).
    \item \textbf{\hyperref[tab:system_GeometricImpedance]{System III}:} The Geometric Impedance ($\alpha^{-1}$).
    \item \textbf{\hyperref[tab:system_SurfaceRegulator]{System IV}:} The Surface Regulator (Higgs Field)
    \item \textbf{\hyperref[tab:system_BulkRegulator]{System V}:} The Bulk Regulator (Gravity).  
    \item \textbf{\hyperref[tab:system_EffectiveFieldLimits]{System VI}:} The Effective Field Limits (Standard Model Constants).
    \item \textbf{\hyperref[tab:system_ArchitectureOfMatter]{System VII}:} Architecture of Matter (Particles)
\label{}
...
\begin{table*}[h]
\centering
\caption{\textbf{System III: The Geometric Impedance ($\alpha^{-1}$).} Geometric costs required to sustain a coherent signal against the entropy of the manifold. }
...
\begin{table*}[h]
\centering
\caption{\textbf{System IV: The Surface Regulator (Higgs Field).} The nested persistent system that impedance-matches the lattice resonance to the weak force aperture, creating the Mass Scale.}
...
\textbf{Temporal Tax ($T$)} & Instability ($T_H$) & $2\lambda$ & $\mathbf{0.259}$ & \textbf{Symmetry Breaking:} Cost of the false vacuum ($\mu^2$). \\
...
\begin{table*}[h]
\centering
\caption{\textbf{System V: The Bulk Regulator (Gravity).} The nested persistent system that attenuates bulk signals across the lattice depth, creating the Geometry Scale.}
...
\addlinespace
\multicolumn{5}{l}{\textit{The Thermodynamic Taxes}} \\
\textbf{Temporal Tax ($T$)} & Stiffness & $ds^2 \ge 0$ & $c$ & \textbf{Causality:} Enforcing the light cone limit. \\
...
\multicolumn{5}{c}{\textit{The system impedance achieves Unity at the Planck Scale.}} \\
\bottomrule
\end{tabular}
\end{table*}
...
\begin{table*}[h]
\centering
\caption{\textbf{System VI: The Effective Field Limits.} The physical constants of the Standard Model derived as the operational outputs of the Vacuum Impedance on the $E_8$ lattice.}
...
\textbf{Energy Vessel ($\Delta E$)} & Gravity ($\alpha_G$) &
    $\GravCouplingEq$ & $\mathbf{\GravCouplingVal}$ & \textbf{Bulk Attenuation:} Signal loss across lattice depth. \\
...
\textbf{Protocol ($MI$)} & W Boson Mass ($M_W$) &
    $\WBosonMassEq$ & $\mathbf{\WBosonMassVal}$ GeV & \textbf{Weak Range:} Protocol screening length. \\
