...
To anchor the subsequent derivations, we define the System Specification: the immutable geometric invariants of the vacuum topology. These five integers constitute the complete input set from which the physical universe emerges.
...
\begin{table*}[h]
\centering
\caption{\textbf{System IV: The Effective Field Architecture.} The physical constants of the Standard Model derived as the operational outputs of the Geometric Impedance on the $E_8$ lattice.}
