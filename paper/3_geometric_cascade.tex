...
\midrule
\textbf{Substrate ($S$)} & Invariant Substrate & System I & $\mathbb{S}$ & Metric constraints of the 4D projection. \\
\textbf{Substrate ($S$)} & Impedance ($\alpha^{-1}_{geo}$) & System II & $\mathbb{O}$ & \textbf{Baseline Cost:} The vacuum resistance. \\
\midrule
...
\textbf{Governor ($G$)} & Beta Func. ($\beta_0$) & $11 - \frac{2}{3}n_f$ & $\mathbf{11}$ & \textbf{Field Rigidity:} Vacuum anti-screening limit. \\
\addlinespace
