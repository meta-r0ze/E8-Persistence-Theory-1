...
The \textbf{Temporal Tax} represents the Entropic Action of updating the metric. It defines the "Stiffness" of spacetime against deformation. This tax ($T_{grav}$) scales with the square of the Planck Mass, enforcing the light-cone limit ($ds^2=0$):
\begin{equation}
