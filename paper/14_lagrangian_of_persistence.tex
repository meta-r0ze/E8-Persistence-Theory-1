...
Here, $S_{E_8}$ is the Informational Action. This functional acts as the lattice \textbf{``Ice Rule''}: it assigns infinite entropic cost to any configuration that violates the geometric invariants, ensuring that only the state satisfying $\mathbb{S}$ survives in the thermodynamic limit ($\beta \to \infty$).
