...
\textbf{The $E_8$ Derivation:} In this framework, the $W$ and $Z$ bosons are coupled via the \textbf{Geometric Partition} derived in Paper I. The Weak Mixing Angle is not a free parameter but the ratio of the resonant depth ($\Delta$) to the total electroweak capacity ($193$).
\begin{equation}
...
\begin{equation}
M_W = 91.1876 \text{ GeV} \times \sqrt{1 - \frac{43}{193}}
\end{equation}
\begin{equation}
M_W = 91.1876 \times \sqrt{\frac{150}{193}} \approx 91.1876 \times 0.88164
\end{equation}
\begin{equation}
