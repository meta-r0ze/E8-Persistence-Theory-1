\section{System 5: The Surface Regulator (The Higgs Sector) (\texorpdfstring{$v, \lambda, m_H, y_e$}{vlambdamhye})}
...
\begin{equation}
PM = \frac{1}{H_{full} \cdot (\sigma + 1) \cdot \Delta^2} = \frac{1}{31 \cdot 6 \cdot 43^2} \approx \CompPM
\end{equation}
