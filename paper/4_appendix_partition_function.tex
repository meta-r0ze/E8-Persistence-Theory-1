...
\subsubsection{1. The Unitarity Potential (\texorpdfstring{$V_U$}{VU}): History Conservation}
...
\subsubsection{2. The Causality Potential (\texorpdfstring{$V_C$}{VC}): Anti-Aliasing}
...
\subsubsection{3. The Solvency Potential (\texorpdfstring{$V_S$}{VS}): The Noise Floor}
...
\subsubsection{4. The Symmetry Potential (\texorpdfstring{$V_\sigma$}{Vsigma}): Gauge Structure}
