...
\begin{itemize}
    ...
    \item \textbf{The Mass Term ($-m\bar{\psi}\psi$):} This term represents the \textbf{Flux Normalization Impedance}. In this framework, $m$ is not an arbitrary parameter, but the calculated \textbf{Geometric Impedance of the Knot}, the Entropic Action required for a topological defect to maintain its structure against the vacuum flux. As demonstrated in the sequel, this value is strictly determined by the resonant geometry of the lattice excitation, manifesting in the effective field theory as the Yukawa coupling.
\end{itemize}
