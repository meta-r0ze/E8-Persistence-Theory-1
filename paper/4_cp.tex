\subsection{System 4-B: The Topological Structure of the Strong Force (The \texorpdfstring{$\theta_{QCD}$}{thetaQCD} Prohibition)}
\label{sec:StrongCP}
...
\paragraph{The $E_8$-Persistence Derivation}
...
\begin{tabular}{lcc}
\toprule
\textbf{Feature} & \textbf{Peccei-Quinn Mechanism} & \textbf{$E_8$-Persistence} \\
\midrule
