...
When projecting the $E_8$ lattice onto the derived 4D manifold (Section \ref{sec:DerivationOfTheSubstrate}), these universal structural requirements manifest physically as the following geometric invariants:
...
\begin{enumerate}
    ...
    \item \textbf{The Coordination Protocol ($MI$):} \textit{The Efficiency.} The channel regulating flow (Gauge Alignment). In System I, this maps to \textbf{The Chiral Channel} ($\nu=16$).
