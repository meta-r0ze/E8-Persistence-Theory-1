...
Second, utilizing the geometric bandwidth defined in Tier 1, we identify the two nested persistent subsystems that step down the raw lattice resonance ($\Delta = 43$) to create the stable energy scales of our universe:
\begin{enumerate}
    ...
    \item \textbf{The Bulk Regulator (The Gravity System):} A global subsystem that utilizes the \textit{residual} bandwidth to regulate the Geometry Scale ($M_P \approx 10^{19}$ GeV), attenuating bulk signals across the lattice depth.
\end{enumerate}
