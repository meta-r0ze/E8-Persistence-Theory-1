...
\begin{enumerate}
    ...
    \item \textbf{Projected Aperture ($A_{weak}$):} The ideal Weak Aperture ($\sigma + 1 = 6$) must be projected onto the spacetime manifold ($D\Delta = 172$). This introduces a geometric friction term ($1/D\Delta$) analogous to the alignment cost in System II.
    \begin{equation}
    A_{weak} = (\sigma + 1) \left( 1 - \frac{1}{D\Delta} \right) = 6 \left( 1 - \frac{1}{172} \right) \approx \mathbf{\WeakApertureProjVal}
    \end{equation}
\end{enumerate}
