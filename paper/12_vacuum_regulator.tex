...
\CatchFileBetweenTags{\CompPM}{calculations/constants.tex}{CompPM}
...
We must also account for the \textbf{Persistence Margin} ($PM$). Since the vacuum stability floor supports $n_{gen}=3$ generations ($\sigma - \chi = 3$), the noise amplitude per generation is partitioned linearly. This creates a thermodynamic reduction factor:
