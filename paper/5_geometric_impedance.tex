...
Furthermore, this explains the quantization of charge. Because $Z_\Phi$ is constructed strictly from integer topological invariants ($\chi, \sigma$) and the lattice resonance ($\Delta$), the resulting flow $e$ is structurally forced to be discrete.
...
\subsubsection{The Stiffness of the Medium ($Z_0$)}
