...
\begin{enumerate}
    ...
    \item \textbf{The Symmetry Pressure ($\sigma - \chi$):} The internal symmetry ($\sigma=5$) exceeds the topological capacity of the boundary ($\chi=2$). The surplus generators ($\sigma - \chi = 3$) cannot be supported on the boundary.  The surplus symmetry "leaks" out, creating an expansive pressure.
