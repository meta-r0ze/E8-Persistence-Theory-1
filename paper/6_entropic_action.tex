...
\begin{itemize}
    ...
    The energetic cost of binding information. Mass represents a topological knot that has achieved Information Closure, allowing it to store history against the entropic flux of the vacuum. It is the phase-locked memory of the lattice.
    ...
    \begin{itemize}
        ...
        \item \textbf{Persistence Margin ($PM \to \Lambda$):} The resolution floor. The Cosmological Constant $\Lambda$ represents the irreducible energy cost of maintaining spatial volume against the vacuum. (See \cref{sec:vacuum_energy})
    \end{itemize}
\end{itemize}
