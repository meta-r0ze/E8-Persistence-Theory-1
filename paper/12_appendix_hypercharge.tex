...
\subsection{Geometric Isospin ($I_3$):} The $SU(2)_L$ symmetry arises from the topological boundary $\chi=2$, which mandates a doublet structure for left-handed particles. We therefore make the following geometric assignments:
\begin{itemize}
