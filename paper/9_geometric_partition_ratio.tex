...
We now observe that this cost corresponds to the second-order electromagnetic coupling ($\alpha^2$) modulated by the Weak Mixing Angle partition we just derived ($\sin^2 \theta_W = 43/193$).
